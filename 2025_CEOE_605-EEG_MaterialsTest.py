...
from psychopy import sound, core, visual, event, parallel, gui, monitors, clock  #, parallel   # if you change the setting, this command must be put after the prefs's command
#import json
print(sound.Sound)
...
if __name__ == "__main__":
    ...
    instructions = """接下來請依照指示及嗶聲，進行張眼及閉眼\n當你準備好的時候，\n請按下空白鍵開始"""
    instructions_OE = """請持續張眼3分鐘\n準備好時，\n請按下空白鍵開始"""
    instructions_CE = """請持續閉眼3分鐘\n準備好時，\n請按下空白鍵開始"""
    ...
    for i in range(1):
        ...
        # CE instructions
        display_ins(instructions_CE, keypressLIST_space)
        ...
        # beep sound for 0.2 s
        #Script_Sound.play()
        #win.flip()
        #core.wait(0.02) # second not milisecond
        ...
        # OE instructions
        display_ins(instructions_OE, keypressLIST_space)
        ...
        # CE start trigger
        port.setData(i+10)  # set all pins low
        # beep sound for 0.2 s
        #Script_Sound.play()
        #core.wait(0.2) # second not milisecond
    ...
    file_name = sub_id + '_CEOE_results.csv'
