...
#prefs.hardware['audioDevice'] = ['Realtek HD Audio', '(Realtek(R) Audio)']
...
print(sound.Sound)
#print(psychopy.hardware.speaker.SpeakerDevice)
...
# To determine the set of available devices
...
if __name__ == "__main__":
    data_path = "E:/Neurolang_1_Copy(ver20231203)/Master Program/New_Thesis_topic/Alice(EEG_mat_and stimuli)/audio/" #"E:/Master Program/New_Thesis_topic/Alice(EEG dataset and stimuli)/audio/"
    results_data_path = "E:/2025R605_EEG_Demo/R605EEG_12QsAns" #"E:/Master Program/New_Thesis_topic/Experiments_Results/12Qs_Ans/"
    ...
    for i in range(5):
        ...
        #preSetSound = sound.setSound
        Script_Sound = sound.Sound(value=str(Alice_stm) , secs=t+1)   #value=str(Alice_stm), secs = 60)
        #now = ptb.GetSecs()
        ...
        # Use the tape length to play and start from the timepoint of the .GetSecs()
        Script_Sound.play() #when=now+int(t+1))
