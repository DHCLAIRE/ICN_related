...
%directoryBase = [pwd '/'];
directoryBase = ['/Users/neuroling/Downloads/DINGHSIN_Results/Alice_Experiments_Results/Stimuli_Alice_audio/'];
fileName = 'DownTheRabbitHoleFinal_SoundFile9.wav';
...
if plotFigures
    ...
    plot(rc.temporalPositions,rc.f0.*rc.vuv, 'r');grid on
    set(gca,'fontsize',14);
    xlabel('time (s)')
